...
(
    ...
    applicant_name       TEXT            NULL COLLATE ascii_bin,
    ...
    form_name            TEXT            NULL COLLATE ascii_bin,
    submitted_by         CHAR(36)        NULL COLLATE ascii_bin,
    title                TEXT            NULL COLLATE ascii_bin,
    ...
    first_submitted_date TIMESTAMP       NOT NULL DEFAULT CURRENT_TIMESTAMP,
    last_submitted_date  TIMESTAMP       NOT NULL DEFAULT CURRENT_TIMESTAMP,
